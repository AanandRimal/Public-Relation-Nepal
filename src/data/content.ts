...
export const homepage: Homepage = {
  hero: {
    ...
    stats: [
      { id: "1", value: "500", label: "Projects Delivered", suffix: "+" },
      { id: "2", value: "150", label: "Enterprise Clients", suffix: "+" },
      { id: "3", value: "15", label: "Years of Excellence", suffix: "+" },
      { id: "4", value: "25", label: "Industry Awards", suffix: "+" },
    ],
  },
  featuredServiceIds: [
    "public-relations",
  ...
  statistics: [
    { id: "1", value: "500", label: "Projects Delivered", suffix: "+" },
    { id: "2", value: "150", label: "Clients Served", suffix: "+" },
    { id: "3", value: "50", label: "Team Members", suffix: "+" },
    { id: "4", value: "15", label: "Years Experience", suffix: "+" },
  ],
  awardIds: ["1", "2", "3", "4"],
